...
public sealed class AdminPanelViewModel : ObservableObject
{
    ...
    public async Task LoadAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            ProcessItems.Add(new AdminProcessItem("Reports", "Receipts from paid orders, discounts, taxes, grand totals, cashier attribution, and payments.", "Paid orders", $"PHP {sales.Sum(sale => sale.GrandTotal):N2}", nameof(SalesPage)));
